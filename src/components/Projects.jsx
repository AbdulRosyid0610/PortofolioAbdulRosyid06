const PROJECTS = [
  {
    ...
    preview: (
      <>
        ...
        <div className="prev-blocks">
          <div className="prev-block accent" /><div className="prev-block" />
        </div>
    ...
    title: <>E-Commerce Restaurant<br />Management Dashboard</>,
  ...
  },
  {
    ...
    preview: (
      <>
        ...
        <div className="prev-line w-3q" />
        <div className="prev-blocks">
          <div className="prev-block" /><div className="prev-block accent" />
          <div className="prev-block accent" /><div className="prev-block" />
        </div>
        <div className="prev-line w-half" />
      </>
    ...
    tags: ["React", "JSX", "CSS"],
    title: <>E-Commerce PustakaNusa<br />Dashboard</>,
  ...
  return (
    <section id="projects" className="section projects-section">
      ...
      <h2 className="section-heading">
        Kumpulan Project <em>Saya</em><br />Yang sudah di praktikan
      </h2>
